Feature: System Administration
  ...
  Rule: System configuration must be flexible
    ...
    And connection testing is available for each integration
  ...
  Rule: System maintenance ensures reliability
    ...
    And historical trends and alerts are displayed
  ...
  Rule: Security configuration protects data
    ...
    And drill-down to specific events is available
  ...
  Rule: Billing configuration supports revenue
    ...
    And effective dates and version control are maintained
  ...
  Rule: System supports scalability
    ...
    And single sign-on capability is available
  ...
  Rule: Disaster recovery ensures continuity
    ...
    And automated testing and alerts are configured